...
train.init_checkpoint = "output/ov_od_scale_before/model_fianl.pth"
...
model.roi_heads.update(
    ...
    box_pooler=LazyCall(MultiScaleROIPooler)(
        ...
        scale_before_level_assign=True
    ),
...
wandb = {'log': True, 'entity': 'hanchaa', 'proj_name': 'ov-od', 'group_name': 'RN101', 'id': '1hui2k97',
         "config": {
             "lr": optimizer["lr"],
